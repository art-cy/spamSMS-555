...
time.sleep(1)
os.system("clear")
os.system("figlet -f mono12 APT -GET47 | lolcat")
time.sleep(1)
print("\033[1;91mCreat By H4CK H33")
#########################
time.sleep(1)
print("\033[1;91mเช็กข้อมูล...")
time.sleep(1)
num = input('\033[36m(ตัวอย่าง +6694xxxxxx)\033[1;92m --->  ')
lim = int(input('\033[1;91mใส่จำนวน  ---> \033[1;92m '))
numplus = '+' + num
def spam():
        try:
